...
// Compute samples with partially overlapping batches

// bool eval_poly_sign_change_2(vec3 coeffs)
// {
//     const int batches = 2;
//     const int samples = batches * 3 + 1;
//     const float spacing = 1.0 / float(samples - 1);
//     const vec4 stride = vec4(spacing * 3.0);
...
//         points += stride;
//         values = eval_poly(coeffs, points);
//         change = change || sign_change(values);
//     }

//     return change;
// }

// bool eval_poly_sign_change_2(vec4 coeffs)
// {
//     const int batches = 3;
//     const int samples = batches * 3 + 1;
//     const float spacing = 1.0 / float(samples - 1);
...
// bool eval_poly_sign_change_2(float coeffs[5])
// {
//     const int batches = 4;
//     const int samples = batches * 3 + 1;
//     const float spacing = 1.0 / float(samples - 1);
...
// bool eval_poly_sign_change_2(float coeffs[6])
// {
//     const int batches = 5;
//     const int samples = batches * 3 + 1;
//     const float spacing = 1.0 / float(samples - 1);
