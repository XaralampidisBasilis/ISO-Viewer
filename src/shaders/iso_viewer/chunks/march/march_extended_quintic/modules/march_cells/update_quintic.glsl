...
quintic.intensities[1] = sample_trilaplacian_intensity_map(camera.position + ray.direction * quintic.distances[1]).a;
quintic.intensities[2] = sample_trilaplacian_intensity_map(camera.position + ray.direction * quintic.distances[2]).a;
quintic.intensities[3] = sample_trilaplacian_intensity_map(camera.position + ray.direction * quintic.distances[3]).a;
quintic.intensities[4] = sample_trilaplacian_intensity_map(camera.position + ray.direction * quintic.distances[4]).a;
quintic.intensities[5] = sample_trilaplacian_intensity_map(camera.position + ray.direction * quintic.distances[5]).a;
...
cell.intersected = cell.intersected || is_quintic_solvable(quintic.coefficients, quintic.interval);
