...
// compute radius
block.skip_distance = sample_anisotropic_distance(block.coords, ray.octant);
block.occupied = (block.skip_distance == 0);
...
ivec3 stepped_coords = block.coords + block.exit_face * block.skip_distance * ray.signs;
