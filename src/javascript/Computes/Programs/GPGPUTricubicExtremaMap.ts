...
export function computeTricubicExtremaMap(inputTensor: tf.Tensor3D, inputStride: number) : tf.Tensor
{
    const program = new GPGPUTricubicExtremaMap(inputTensor.shape, inputStride)
