    ...
    addControllersDebugging()
    {
        ...
        this.controllers.debugging = 
        {
            option: folder.add(uniforms, 'option').options({ 
                ...
                trace_error               : 206,
                trace_abs_error           : 207,
                trace_derivative          : 208,
                trace_step_distance       : 209,
                trace_step_scaling        : 210,
                trace_step_count          : 211,
                trace_mean_step_scaling   : 212,
                trace_mean_step_distance  : 213,
                ...
                frag_view_angle           : 605,
                frag_camera_angle         : 606,
                frag_mapped_value         : 607,
                frag_mapped_color         : 608,
