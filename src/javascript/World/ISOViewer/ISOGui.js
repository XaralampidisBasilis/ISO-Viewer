    ...
    addControllersDebugging()
    {
        ...
        this.controllers.debugging = 
        {
            option: folder.add(uniforms, 'option').options({ 
                ...
                block_occupied          : 502,
                block_terminated        : 503,
                block_coords            : 504,
                block_coords_step       : 505,
                block_min_position      : 506,
                block_max_position      : 507,
                block_entry_distance    : 508,
                block_exit_distance     : 509,
                block_entry_position    : 510,
                block_exit_position     : 511,
