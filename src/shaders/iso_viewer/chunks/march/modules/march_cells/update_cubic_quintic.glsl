...
vec3 h0_h1_h2 = quintic.sample_bernstein[0] * a0_a2_a3 + quintic.sample_bernstein[2] * a4_a5_a6;
vec3 h3_h4_h5 = quintic.sample_bernstein[1] * a0_a2_a3 + quintic.sample_bernstein[3] * a4_a5_a6;

float ac = max(mmax(abs(h0_h1_h2)), mmax(abs(h3_h4_h5)));
