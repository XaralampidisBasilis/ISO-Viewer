...
cell.exit_distance = intersect_box_exit(cell.min_position, cell.max_position, camera.position, ray.inv_direction, cell.exit_axis);
...
cell.coords[cell.exit_axis] += ray.signs[cell.exit_axis];
