...
g0_g1_g2 = matrixCompMult(g0_g1_g2, g0_g1_g2 - 1.0) * 0.5;
...
mat3 B = poly.inv_vander3 * g0_g1_g2;
mat4x3 C = B * mat4x3(A);

// Combine all the coefficients to reconstruct the quintic
// Start from the trilinear interpolation coefficients
poly.coeffs[0] = C[0][0] + A[0][3];
poly.coeffs[1] = C[1][0] + C[0][1] + A[1][3];
poly.coeffs[2] = C[2][0] + C[1][1] + C[0][2] + A[2][3];
poly.coeffs[3] = C[3][0] + C[2][1] + C[1][2] + A[3][3];
