...
const int MAX_NUM_FETCHES = MAX_GROUPS * (MAX_BLOCKS_PER_GROUP + MAX_CELLS_PER_BLOCK * 3 + 1) + 12;
const int MAX_NUM_STEPS = MAX_GROUPS * (MAX_BLOCKS_PER_GROUP);
const int MAX_NUM_SKIPS = MAX_GROUPS * (MAX_BLOCKS_PER_GROUP + MAX_CELLS_PER_BLOCK);