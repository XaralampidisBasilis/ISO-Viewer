...
export function blockExtremaPackedProgram(interpolationMap: tf.Tensor5D, inputStride: number, inputMethod: 0 | 1) : tf.Tensor
{
    const interpolationMethod = ['trilinear', 'tricubic'][inputMethod] as 'trilinear' | 'tricubic'
