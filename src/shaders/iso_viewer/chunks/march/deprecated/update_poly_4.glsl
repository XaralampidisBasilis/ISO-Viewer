...
poly.f0_f1_f2_f3.y = sample_trilaplacian_intensity(mix(cell.entry_position, cell.exit_position, poly.t0_t1_t2_t3[1]), poly.fxx_fyy_fzz_f[1], poly.gxx_gyy_gzz_g[0]);
poly.f0_f1_f2_f3.z = sample_trilaplacian_intensity(mix(cell.entry_position, cell.exit_position, poly.t0_t1_t2_t3[2]), poly.fxx_fyy_fzz_f[2], poly.gxx_gyy_gzz_g[1]);
poly.f0_f1_f2_f3.w = sample_trilaplacian_intensity(mix(cell.entry_position, cell.exit_position, poly.t0_t1_t2_t3[3]), poly.fxx_fyy_fzz_f[3], poly.gxx_gyy_gzz_g[2]);
...
mat4x3 bxx_byy_bzz_b = transpose(poly.gxx_gyy_gzz_g * poly.inv_vander3);

mat3x4 AB = 
outerProduct(axx_ayy_azz_a[0], bxx_byy_bzz_b[0]) +
outerProduct(axx_ayy_azz_a[1], bxx_byy_bzz_b[1]) +
outerProduct(axx_ayy_azz_a[2], bxx_byy_bzz_b[2]) +
outerProduct(axx_ayy_azz_a[3], bxx_byy_bzz_b[3]);
