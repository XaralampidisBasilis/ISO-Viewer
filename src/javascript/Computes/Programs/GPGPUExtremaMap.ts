...
class GPGPUExtremaMap implements GPGPUProgram 
{
    ...
    {        
        ...
        this.outputShape = [outDepth, outHeight, outWidth, 2]  
        ...
        float getBernsteinCoeff(int cellX, int cellY, int cellZ, int coeffX, int coeffY, int coeffZ)
        {
        ...
        vec2 getCellExtrema(int cellX, int cellY, int cellZ)
        {
            ...
            for (int coeffX = 0; coeffX < 4; ++coeffX) {
                ...
                float bernsteinCoeff = getBernsteinCoeff(cellX, cellY, cellZ, coeffX, coeffY, coeffZ);
        ...
        void main()
        {
            ...
            setOutput((outputCoords.w == 0) ? blockExtrema.x : blockExtrema.y);
        }  
        `
    }
}
