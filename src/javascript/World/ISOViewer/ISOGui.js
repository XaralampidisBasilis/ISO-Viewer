    ...
    addControllersDebugging()
    {
        ...
        this.controllers.debugging = 
        {
            option: folder.add(uniforms, 'option').options({ 
                ...
                cell_terminated         : 302,
                cell_coords             : 303,
                cell_max_position       : 304,
                cell_min_position       : 305,
                cell_entry_distance     : 306,
                cell_exit_distance      : 307,
                cell_span_distance      : 308,

                block_radius            : 401,
                block_occupied          : 402,
                block_terminated        : 403,
                block_coords            : 404,
                block_min_position      : 405,
                block_max_position      : 406,
                block_entry_distance    : 407,
                block_exit_distance     : 408,
                block_entry_position    : 409,
                block_exit_position     : 410,
                ...
                frag_mapped_intensity   : 511,     
                frag_mapped_color       : 512,     
                frag_ambient_color      : 513,     
                frag_diffuse_color      : 514,     
                frag_specular_color     : 515,     
                frag_shaded_color       : 516,     
