...
trilinear_sobel_gradient_hessian_laplacian(u_textures.intensity_map, trace.position, normalize(u_intensity_map.spacing), surface.gradient, surface.hessian, surface.laplacian);
...
float laplacian_curvature = (surface.laplacian / length(surface.gradient)) * 0.5;
