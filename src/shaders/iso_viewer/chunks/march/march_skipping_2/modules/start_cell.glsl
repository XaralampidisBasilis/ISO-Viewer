...
// Compute cell coords at block entry position
...
cell.sample_intensities.x = texture(u_textures.intensity_map, camera.uvw + ray.direction_uvw * cell.sample_distances.x).r;
