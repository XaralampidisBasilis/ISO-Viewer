...
// compute radii
block.radii = sample_extended_distance(block.coords, ray.octant, block.occupied);
...
block.coords += block.radii * block.exit_axes * ray.signs;
block.coords = pick(bvec3(block.exit_axes), block.coords, coords);
