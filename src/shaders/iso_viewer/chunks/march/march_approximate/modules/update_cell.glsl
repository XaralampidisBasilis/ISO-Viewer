...
cell.sample_distances.x = cell.sample_distances.z;
cell.sample_distances.yz = mmix(cell.entry_distance, cell.exit_distance, weights_vec3.yz);

// compute the intensity samples inside the cell from the intensity map texture
cell.sample_intensities.x = cell.sample_intensities.z;
...
cell.intersected = is_quadratic_solvable
(
    cell.intensity_coeffs.xyz, 
