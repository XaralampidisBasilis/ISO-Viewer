...
mat4x3 B = poly.transp_inv_vander3 * gxx_gyy_gzz_g;
mat4x3 BA = B * A;

// Combine all the coefficients to reconstruct the quintic
// Start from the trilinear interpolation coefficients
poly.coeffs[0] = BA[0][0];
poly.coeffs[1] = BA[1][0] + BA[0][1];
poly.coeffs[2] = BA[2][0] + BA[1][1] + BA[0][2];
poly.coeffs[3] = BA[3][0] + BA[2][1] + BA[1][2];
...
cell.intersected = is_quintic_solvable(poly.coeffs, poly.t0_t1_t2_t3.xw);
