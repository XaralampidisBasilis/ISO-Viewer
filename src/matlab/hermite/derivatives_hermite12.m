...
P1_x = simplify(subs(P1_x, [a0 a1 b1 b2], [sol.a0, sol.a1, sol.b1, sol.b2]));
P2_x = simplify(subs(P2_x, [a0 a1 b1 b2], [sol.a0, sol.a1, sol.b1, sol.b2]));
P3_x = simplify(subs(P3_x, [a0 a1 b1 b2], [sol.a0, sol.a1, sol.b1, sol.b2]));
N0_x = simplify(subs(N0_x, [a0 a1 b1 b2], [sol.a0, sol.a1, sol.b1, sol.b2]));
N1_x = simplify(subs(N1_x, [a0 a1 b1 b2], [sol.a0, sol.a1, sol.b1, sol.b2]));
N2_x = simplify(subs(N2_x, [a0 a1 b1 b2], [sol.a0, sol.a1, sol.b1, sol.b2]));
N3_x = simplify(subs(N3_x, [a0 a1 b1 b2], [sol.a0, sol.a1, sol.b1, sol.b2]));
D0_x = simplify(subs(D0_x, [a0 a1 b1 b2], [sol.a0, sol.a1, sol.b1, sol.b2]));
D1_x = simplify(subs(D1_x, [a0 a1 b1 b2], [sol.a0, sol.a1, sol.b1, sol.b2]));
D2_x = simplify(subs(D2_x, [a0 a1 b1 b2], [sol.a0, sol.a1, sol.b1, sol.b2]));
D3_x = simplify(subs(D3_x, [a0 a1 b1 b2], [sol.a0, sol.a1, sol.b1, sol.b2]));
